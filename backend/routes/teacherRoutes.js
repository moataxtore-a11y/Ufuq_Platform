...
const { listPublicTeachers, getPublicTeacherById, listMyTeam, createMyTeamMember, updateMyTeamMember, ensureMyTeamId, getTeacherDashboardStats } = require('../controllers/teacherController')
...
router.get('/me/stats', getTeacherDashboardStats)
