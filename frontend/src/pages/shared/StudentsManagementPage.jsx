            ...
            <div className={"flex items-center gap-2 " + (isRtl ? 'flex-row-reverse justify-end' : 'flex-row justify-start')}>
              <button
                ...
                className={
                  ...
                  (grantMode === 'fixed'
                    ? 'bg-[rgba(244,206,125,0.40)] border-[rgba(244,206,125,0.55)] text-slate-900 dark:text-slate-100'
              ...
              <TR>
                {(auth?.role === 'teacher' || auth?.role === 'team') ? (
                  <TH className="w-[56px] text-center">
                    <input
                      type="checkbox"
                      className="w-4 h-4 accent-[rgb(20,184,166)] cursor-pointer"
                          ...
                          className={
                            auth?.role === 'teacher'
                              ? (u?.isSuspended
                                ...
                                : 'border-[rgba(212,175,55,0.55)] text-[rgb(161,98,7)] hover:bg-[rgba(244,206,125,0.25)]')
                              : undefined
                          }
