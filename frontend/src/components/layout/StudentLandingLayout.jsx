          ...
          <div className="hidden sm:flex items-center justify-between gap-4 h-10">
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              <button
                type="button"
                onClick={() => setOpen(true)}
                className="relative flex items-center justify-center shrink-0 rounded-full w-9 h-9 border-2 border-slate-200 dark:border-white/20 hover:border-teal-500/50 transition-colors shadow-sm"
                aria-label={isRtl ? 'القائمة' : 'Menu'}
                title={isRtl ? 'القائمة' : 'Menu'}
              >
                <span className="flex h-full w-full items-center justify-center overflow-hidden rounded-full">
