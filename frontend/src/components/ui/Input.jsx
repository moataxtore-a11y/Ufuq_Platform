  ...
  return (
    <input
      className={cn(
        ...
        'focus-visible:border-amber-300 focus-visible:ring-2 focus-visible:ring-amber-300/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white',
        'disabled:cursor-not-allowed disabled:opacity-50',
        className,
        'dark:border-white/15 dark:bg-white/[0.06] dark:text-white dark:placeholder:text-slate-400',
        'dark:focus-visible:border-amber-200/60 dark:focus-visible:ring-amber-200/30 dark:focus-visible:ring-offset-neutral-950'
      )}
      {...props}
    />
  )
